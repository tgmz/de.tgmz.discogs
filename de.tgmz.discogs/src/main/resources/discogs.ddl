...
create table SubTrack_ExtraArtist (SubTrack_subTrackNumber smallint not null, SubTrack_track_release_id integer not null, SubTrack_track_sequence smallint not null, extraArtists_artist_id integer not null, extraArtists_role varchar(255) not null, constraint SubTrack_ExtraArtist_pk_idx unique (SubTrack_track_release_id, SubTrack_track_sequence, SubTrack_subTrackNumber, extraArtists_artist_id, extraArtists_role))
...
create table Track_Artist (Track_release_id integer not null, Track_sequence smallint not null, artists_id integer not null, constraint Track_Artist_pk_idx unique (Track_release_id, Track_sequence, artists_id))
create table Track_ExtraArtist (Track_release_id integer not null, Track_sequence smallint not null, extraArtists_artist_id integer not null, extraArtists_role varchar(255) not null, constraint Track_ExtraArtist_pk_idx unique (Track_release_id, Track_sequence, extraArtists_artist_id, extraArtists_role))
