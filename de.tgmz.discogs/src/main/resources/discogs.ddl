...
create index name_idx on Artist (name)
create index name_idx on Company (name)
create index name_idx on Label (name)
create index title_idx on Master (title)
create index albumArtist_idx on Master (albumArtist)
create index albumArtist_title_idx on Release (albumArtist, title)
create index albumArtist_idx on Release (albumArtist)
create index title_idx on Release (title)
create index name_idx on Artist (name)
create index name_idx on Company (name)
create index name_idx on Label (name)
create index title_idx on Master (title)
