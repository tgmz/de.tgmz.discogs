...
create table ExtraArtist (artist_id integer not null, role varchar(255) not null, constraint ExtraArtist_pkey primary key (artist_id, role))
...
create table release_extraartist (artist_id integer not null, release_id integer not null, role_id varchar(255) not null, constraint ReleaseExtraArtist_pkey primary key (release_id, artist_id, role_id))
...
create table Track_ExtraArtist (Track_release_id integer not null, Track_sequence smallint not null, extraArtists_artist_id integer not null, extraArtists_role varchar(255) not null, constraint Track_ExtraArtist_pkey unique (Track_release_id, Track_sequence, extraArtists_artist_id, extraArtists_role))
