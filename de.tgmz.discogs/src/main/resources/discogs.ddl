...
--**********************************************************************/
create global temporary table HTE_Format(id integer, rn_ integer not null, name varchar(255), qty varchar(255), text varchar(255), primary key (rn_)) transactional
create global temporary table HTE_Identifier(_type smallint, id integer, rn_ integer not null, _description varchar(255), _value varchar(255), primary key (rn_)) transactional
create sequence format_seq start with 1 increment by 1
create sequence identifier_seq start with 1 increment by 1
create table Artist (data_quality smallint check ((data_quality between 0 and 5)), id integer not null, name varchar(512), realname varchar(512), primary key (id))
...
create table Artist_variations (Artist_id integer not null, variations varchar(255))
...
create table Master (data_quality smallint check ((data_quality between 0 and 5)), id integer not null, published integer, albumArtist varchar(512), title varchar(512), primary key (id))
create table Master_Artist (Master_id integer not null, artists_id integer not null, primary key (Master_id, artists_id))
create table Master_Genre (Master_id integer not null, genres_id varchar(255) not null, primary key (Master_id, genres_id))
create table Master_Style (Master_id integer not null, styles_id varchar(255) not null, primary key (Master_id, styles_id))
create table Release (_main boolean not null, data_quality smallint check ((data_quality between 0 and 5)), id integer not null, master_id integer, series_id integer, albumArtist varchar(512), title varchar(512), country varchar(255), released varchar(255), primary key (id))
create table Release_Artist (Release_id integer not null, artists_id integer not null, primary key (Release_id, artists_id))
create table release_company (company_id integer not null, entityType_id smallint not null, release_id integer not null, constraint ReleaseCompany_pk_idx primary key (release_id, company_id, entityType_id))
...
create table Release_Format (Release_id integer not null, formats_id integer not null, primary key (Release_id, formats_id))
create table Release_Genre (Release_id integer not null, genres_id varchar(255) not null, primary key (Release_id, genres_id))
create table Release_Identifier (Release_id integer not null, identifiers_id integer not null, primary key (Release_id, identifiers_id))
...
create table Release_Style (Release_id integer not null, styles_id varchar(255) not null, primary key (Release_id, styles_id))
...
create table ReleaseExtraArtist_applicableTracks (ReleaseExtraArtist_artist_id integer not null, ReleaseExtraArtist_release_id integer not null, ReleaseExtraArtist_role_id varchar(255) not null, applicableTracks varchar(255))
...
create table SubTrack (subTrackNumber smallint not null, track_release_id integer not null, track_sequence smallint not null, title varchar(512), duration varchar(255), position varchar(255), constraint SubTrack_pk_idx primary key (track_release_id, track_sequence, subTrackNumber))
create table SubTrack_ExtraArtist (SubTrack_subTrackNumber smallint not null, SubTrack_track_release_id integer not null, SubTrack_track_sequence smallint not null, extraArtists_artist_id integer not null, extraArtists_role varchar(255) not null, constraint SubTrack_ExtraArtist_pk_idx primary key (SubTrack_track_release_id, SubTrack_track_sequence, SubTrack_subTrackNumber, extraArtists_artist_id, extraArtists_role))
create table Track (release_id integer not null, sequence smallint not null, trackNumber smallint not null, title varchar(512), duration varchar(255), position varchar(255), constraint Track_pk_idx primary key (release_id, sequence))
create table Track_Artist (Track_release_id integer not null, Track_sequence smallint not null, artists_id integer not null, constraint Track_Artist_pk_idx primary key (Track_release_id, Track_sequence, artists_id))
create table Track_ExtraArtist (Track_release_id integer not null, Track_sequence smallint not null, extraArtists_artist_id integer not null, extraArtists_role varchar(255) not null, constraint Track_ExtraArtist_pk_idx primary key (Track_release_id, Track_sequence, extraArtists_artist_id, extraArtists_role))
create table Track_SubTrack (Track_release_id integer not null, Track_sequence smallint not null, subTracklist_subTrackNumber smallint not null, subTracklist_track_release_id integer not null, subTracklist_track_sequence smallint not null, constraint Track_SubTrack_pk_idx unique (subTracklist_track_release_id, subTracklist_track_sequence, subTracklist_subTrackNumber))
...
alter table if exists ReleaseExtraArtist_applicableTracks add constraint FKpudemcxynsvkgqrtt8wlalnsv foreign key (ReleaseExtraArtist_release_id, ReleaseExtraArtist_artist_id, ReleaseExtraArtist_role_id) references release_extraartist
...
create table artist_aliases_all (id integer not null, name varchar(512))
create table artist_groups_all (id integer not null, name varchar(512))
create table artist_members_all (id integer not null, name varchar(512))

create table artist_master_all (id integer not null, name varchar(512))

create table artist_release_all (id integer not null, name varchar(512))
create table artist_release_extraartist_all (id integer not null, name varchar(512))
create table artist_release_track_all (id integer not null, name varchar(512))
create table artist_release_track_extraartist_all (id integer not null, name varchar(512))
create table artist_release_subtrack_extraartist_all (id integer not null, name varchar(512))
