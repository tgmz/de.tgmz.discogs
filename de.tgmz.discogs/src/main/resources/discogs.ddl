...
create table release_company (entityType_id smallint not null, company_id bigint not null, release_id bigint not null, constraint ReleaseCompany_pk_idx primary key (release_id, company_id, entityType_id))
...
create table SubTrack (subTrackNumber smallint not null, track_sequence smallint not null, track_release_id bigint not null, title varchar(512), duration varchar(255), position varchar(255), constraint SubTrack_pk_idx primary key (track_release_id, track_sequence, subTrackNumber))
create table SubTrack_ExtraArtist (SubTrack_subTrackNumber smallint not null, SubTrack_track_sequence smallint not null, SubTrack_track_release_id bigint not null, extraArtists_artist_id bigint not null, extraArtists_role varchar(255) not null, constraint SubTrack_ExtraArtist_pk_idx primary key (SubTrack_track_release_id, SubTrack_track_sequence, SubTrack_subTrackNumber, extraArtists_artist_id, extraArtists_role))
create table Track (sequence smallint not null, trackNumber smallint not null, release_id bigint not null, title varchar(512), duration varchar(255), position varchar(255), constraint Track_pk_idx primary key (release_id, sequence))
create table Track_Artist (Track_sequence smallint not null, Track_release_id bigint not null, artists_id bigint not null, constraint Track_Artist_pk_idx primary key (Track_release_id, Track_sequence, artists_id))
create table Track_ExtraArtist (Track_sequence smallint not null, Track_release_id bigint not null, extraArtists_artist_id bigint not null, extraArtists_role varchar(255) not null, constraint Track_ExtraArtist_pk_idx primary key (Track_release_id, Track_sequence, extraArtists_artist_id, extraArtists_role))
create table Track_SubTrack (Track_sequence smallint not null, subTracklist_subTrackNumber smallint not null, subTracklist_track_sequence smallint not null, Track_release_id bigint not null, subTracklist_track_release_id bigint not null, constraint Track_SubTrack_pk_idx unique (subTracklist_track_release_id, subTracklist_track_sequence, subTracklist_subTrackNumber))
