...
create table Label (data_quality smallint check ((data_quality between 0 and 5)), id integer not null, parentLabel_id integer, name varchar(255), contactinfo clob, primary key (id))
...
create table Release_Identifier (Release_id integer not null, identifiers_id integer not null, primary key (identifiers_id))
